...
function SpotlightCard({ img, title, address, btnname }: any) {
    return (
        <div className=" mx-auto px-4 py-8">
            <div className="bg-white shadow-md rounded overflow-hidden max-w-sm inset-x-1  pt-2 ">
                ...
                <div className=' flex justify-center items-center  flex-col space-y-3 text-sm py-2 px-2'>
